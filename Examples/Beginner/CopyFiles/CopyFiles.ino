...
/********************************************************
 ...
 --HOW TO:
  ...
  -load "microSD card root contents" to the microSD card root path with PC.
  -connect the SmartDRIVE with the proper wires and insert microSD card in SmartDRIVE.
  ...
  -remove microSD card from SmartDRIVE and search for the files on a PC with the copied contents.
...
void loop() { //main loop
    ...
    //umount the drive
    sd.mountUnmountDrive();   //Arduino LED next to pin 13 will be shut OFF  
    while(1);
}
